...
Azure OpenAI implementation of the common LLM provider interface.
...
workflow can ask the user targeted follow-up questions.
"""
...
class AzureOpenAIProvider(LLMProvider):
    """
    Requirement-extraction provider using Azure OpenAI.
    """
...
"""
        ...
        for attempt in range(retries):
            ...
            try:
                ...
                logger.info(
                    "Calling Azure OpenAI (attempt %d/%d)...",
                    attempt + 1,
                    retries,
                )
                ...
                if attempt < retries - 1:
                    ...
                    logger.error(
                        "Azure OpenAI failed after %d attempts.",
                        retries,
                    )
        ...
        for attempt in range(
            ...
            try:
                ...
                if not isinstance(
                    ...
                    raise ValueError(
                        "Azure OpenAI engineering-review "
    ...
    def synthesize_engineering_recommendations(
        ...
        for attempt in range(
            ...
            try:
                ...
                logger.warning(
                    "Azure OpenAI "
                    "engineering-recommendation request "
                    "failed: %s",
                    exc,
                )
